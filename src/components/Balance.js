...
const Balance = () => {
  ...
  /* Make sure about both "contract" and "contracts" being correct */
...
/* Get data from blockchain confirming that deposit/transfer was successful */ 


/* Make deposit/transfer */
