...
/* "token" is contract in "TOKEN_LOADED_1", token, symbol */
...
/* We load exchange contract
We input exchange contract with "exchange" */
...
/* LOAD ALL ORDERS 
"0, block" = from block 0 (zero) to the current block */
